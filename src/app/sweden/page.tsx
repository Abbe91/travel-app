  ...
  const culturalHighlights = [
    {
      title: "Cuisine",
      description:
        "Experience the unique flavors of Sweden's cuisine, from traditional dishes to modern culinary delights.",
      image: kok.src,
    },
    {
      title: "Festivals",
    ...
    },
    {
      title: "Art and Music",
      description:
        "Discover the vibrant art and music scene in Sweden, featuring local and international talents.",
      image: kok.src,
    },
    {
      title: "Historical Sites",
      description:
        "Explore the historical sites of Sweden, each with its own unique story and significance.",
      image: kok.src,
    },
  ];
