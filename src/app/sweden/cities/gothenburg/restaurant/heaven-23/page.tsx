                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="carousel">
                        <div className="review-item text-center bg-white p-8 rounded-lg shadow-lg">
                            <p className="text-xl italic mb-4 text-primary">"Absolutely fantastic! The food was out of this world."</p>
                            <p className="font-semibold text-primary">- Happy Customer</p>
                        </div>
